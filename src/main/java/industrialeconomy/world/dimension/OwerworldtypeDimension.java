...
import industrialeconomy.item.OwerworldtypeItem;
...
public class OwerworldtypeDimension extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:owerworldtype_portal")
	public static final CustomPortalBlock portal = null;
	public OwerworldtypeDimension(IndustrialEconomyModElements instance) {
		super(instance, 495);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(HardenedcobbleBlock.block).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("industrial_economy:owerworldtype"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("owerworldtype_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("owerworldtype_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())),
					0, 1).setRegistryName("owerworldtype_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new OwerworldtypeItem().setRegistryName("owerworldtype"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("owerworldtype_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("industrial_economy:owerworldtype"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("industrial_economy:owerworldtype")));
				} else {
					entity.func_242279_ag();
