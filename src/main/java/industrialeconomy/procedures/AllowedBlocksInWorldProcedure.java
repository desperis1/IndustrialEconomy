...
public class AllowedBlocksInWorldProcedure {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		...
		if (Blocks.DIRT == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()
				...
				|| Blocks.DARK_OAK_SAPLING == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()
				|| Blocks.SUGAR_CANE == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()
				|| Blocks.BAMBOO_SAPLING == (world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock()) {
			return true;
		}
		return false;
	}
