							...
							if ((((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz))))
								...
								if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
									((PlayerEntity) entity).sendStatusMessage(
											new StringTextComponent((("Free Iron Node Found On:") + "" + ("  X:") + "" + (Math.round(((x + sx) + 1)))
								...
								if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
									((PlayerEntity) entity).sendStatusMessage(
											new StringTextComponent(
													(("Free Caterium Node Found On:") + "" + ("  X:") + "" + (Math.round(((x + sx) + 1))) + ""
															+ ("  Y:") + "" + (Math.round((y + sy))) + "" + ("  Z:") + "" + (Math.round((z + sz))))),
											(false));
								}
								mark_height = (double) 3;
				...
				for (int index8 = 0; index8 < (int) (100); index8++) {
					...
					for (int index9 = 0; index9 < (int) (100); index9++) {
						...
						for (int index10 = 0; index10 < (int) (100); index10++) {
							if ((((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz))))
									.getBlock() == CoalNodeBlock.block)
									&& (!((world.getBlockState(new BlockPos((int) (x + sx), (int) ((y + sy) + 1), (int) (z + sz))))
											.getBlock() == MinerblockBlock.block)))) {
								if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
									((PlayerEntity) entity).sendStatusMessage(
											new StringTextComponent((("Free Coal Node Found On:") + "" + ("  X:") + "" + (Math.round(((x + sx) + 1)))
													+ "" + ("  Y:") + "" + (Math.round((y + sy))) + "" + ("  Z:") + "" + (Math.round((z + sz))))),
											(false));
								}
								mark_height = (double) 3;
						...
						for (int index14 = 0; index14 < (int) (100); index14++) {
							if ((((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz))))
								...
								if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
									((PlayerEntity) entity).sendStatusMessage(
											new StringTextComponent(
													(("Free Copper Node Found On:") + "" + ("  X:") + "" + (Math.round(((x + sx) + 1))) + ""
															+ ("  Y:") + "" + (Math.round((y + sy))) + "" + ("  Z:") + "" + (Math.round((z + sz))))),
											(false));
								}
								mark_height = (double) 3;
						...
						for (int index18 = 0; index18 < (int) (100); index18++) {
							if ((((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz))))
								...
								if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
									((PlayerEntity) entity).sendStatusMessage(
											new StringTextComponent(
													(("Free SandStone Node Found On:") + "" + ("  X:") + "" + (Math.round(((x + sx) + 1))) + ""
															+ ("  Y:") + "" + (Math.round((y + sy))) + "" + ("  Z:") + "" + (Math.round((z + sz))))),
											(false));
								}
								mark_height = (double) 3;
