...
public class CaseBoxGUIWhileThisGUIIsOpenTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				IndustrialEconomyMod.LOGGER.warn("Failed to load dependency entity for procedure CaseBoxGUIWhileThisGUIIsOpenTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				IndustrialEconomyMod.LOGGER.warn("Failed to load dependency world for procedure CaseBoxGUIWhileThisGUIIsOpenTick!");
			return;
		}
		...
		if (((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY).getOrCreateTag()
				.getBoolean("open")) == (true))) {
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("launched"), (false));
			}
			{
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									_setstack.setCount((int) 1);
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_0))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_1))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_2))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_3))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_4))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_5))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_6))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_7))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								...
								if (invobj instanceof Map) {
									...
									((Slot) ((Map) invobj)
											.get((int) (((entity.getCapability(IndustrialEconomyModVariables.PLAYER_VARIABLES_CAPABILITY, null)
													.orElse(new IndustrialEconomyModVariables.PlayerVariables())).case_item_counter_8))))
															.putStack(_setstack);
									_current.detectAndSendChanges();
								}
							}
