...
public class ServerBlockBlockIsPlacedByProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		IndustrialEconomyModVariables.WorldVariables.get(world).server_x = (double) (Math.floor(x));
		IndustrialEconomyModVariables.WorldVariables.get(world).syncData(world);
		IndustrialEconomyModVariables.WorldVariables.get(world).server_y = (double) (Math.floor(y));
		IndustrialEconomyModVariables.WorldVariables.get(world).syncData(world);
		IndustrialEconomyModVariables.WorldVariables.get(world).server_z = (double) (Math.floor(z));
		IndustrialEconomyModVariables.WorldVariables.get(world).syncData(world);
