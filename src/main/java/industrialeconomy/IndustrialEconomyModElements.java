...
public class IndustrialEconomyModElements {
	...
	public IndustrialEconomyModElements() {
		...
		sounds.put(new ResourceLocation("industrial_economy", "plazma"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == IndustrialEconomyModElements.ModElement.class)
						elements.add((IndustrialEconomyModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(IndustrialEconomyModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new IndustrialEconomyModVariables(this));
	}
