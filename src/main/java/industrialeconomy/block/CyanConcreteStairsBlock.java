...
public class CyanConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:cyan_concrete_stairs")
	public static final Block block = null;
	public CyanConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 327);
	}
