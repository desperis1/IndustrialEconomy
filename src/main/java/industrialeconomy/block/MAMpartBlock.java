...
public class MAMpartBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:ma_mpart")
	public static final Block block = null;

	public MAMpartBlock(IndustrialEconomyModElements instance) {
		super(instance, 557);
	}
