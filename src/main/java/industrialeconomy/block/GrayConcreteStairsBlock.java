...
public class GrayConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:gray_concrete_stairs")
	public static final Block block = null;
	public GrayConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 323);
	}
