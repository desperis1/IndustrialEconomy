...
public class PinkConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:pink_concrete_stairs")
	public static final Block block = null;
	public PinkConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 321);
	}
