...
public class CateriumOreBlock extends IndustrialEconomyModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("industrial_economy:caterium_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("caterium_ore"));
