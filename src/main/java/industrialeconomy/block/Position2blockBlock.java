...
public class Position2blockBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:position_2block")
	public static final Block block = null;

	public Position2blockBlock(IndustrialEconomyModElements instance) {
		super(instance, 262);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			Position2blockBlockIsPlacedByProcedure.executeProcedure(Stream
