...
public class CateriumNodeBlockInactiveBlock extends IndustrialEconomyModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("caterium_node_block_inactive"));
		}
	}

	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(50f, 25f).setLightLevel(s -> 0));
			setRegistryName("caterium_node_block_inactive");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("caterium_node_block_inactive");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Caterium Node Block Inactive");
		}
