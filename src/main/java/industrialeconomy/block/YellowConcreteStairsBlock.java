...
public class YellowConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:yellow_concrete_stairs")
	public static final Block block = null;
	public YellowConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 317);
	}
