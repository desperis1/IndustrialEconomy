...
import industrialeconomy.procedures.CompressorUpdateTickProcedure;
import industrialeconomy.procedures.CompressorBlockIsPlacedByProcedure;

import industrialeconomy.gui.CompressorGUIGui;

import industrialeconomy.IndustrialEconomyModElements;

@IndustrialEconomyModElements.ModElement.Tag
public class CompressorBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:compressor")
	public static final Block block = null;
	@ObjectHolder("industrial_economy:compressor")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public CompressorBlock(IndustrialEconomyModElements instance) {
		super(instance, 477);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				CompressorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
		...
		public void onBlockPlacedBy(World world, BlockPos pos, BlockState blockstate, LivingEntity entity, ItemStack itemstack) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CompressorBlockIsPlacedByProcedure.executeProcedure($_dependencies);
			}
		}
