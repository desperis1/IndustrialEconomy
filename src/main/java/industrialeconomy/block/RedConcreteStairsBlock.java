...
public class RedConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:red_concrete_stairs")
	public static final Block block = null;

	public RedConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 337);
	}
