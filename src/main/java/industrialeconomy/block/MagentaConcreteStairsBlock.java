...
public class MagentaConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:magenta_concrete_stairs")
	public static final Block block = null;

	public MagentaConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 313);
	}
