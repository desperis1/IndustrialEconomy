...
public class LightBlueConcreteStairsBlock extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:light_blue_concrete_stairs")
	public static final Block block = null;
	public LightBlueConcreteStairsBlock(IndustrialEconomyModElements instance) {
		super(instance, 315);
	}
