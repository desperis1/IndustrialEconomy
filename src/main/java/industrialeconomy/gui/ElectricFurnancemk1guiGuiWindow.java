...
public class ElectricFurnancemk1guiGuiWindow extends ContainerScreen<ElectricFurnancemk1guiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("industrial_economy:textures/electric_furnancemk_1gui.png");
		...
		if (GeneratorWorkingLabelProcedure
				.executeProcedure(Stream
						.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
								new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll)))
			this.font.drawString(ms, "Working", 80, 33, -13369600);
		this.font.drawString(ms, "100MW", 139, 5, -16764007);
	}
