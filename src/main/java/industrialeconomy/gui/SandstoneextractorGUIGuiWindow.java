...
public class SandstoneextractorGUIGuiWindow extends ContainerScreen<SandstoneextractorGUIGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 59, this.guiTop + 59, 55, 20, new StringTextComponent("ON/OFF"), e -> {
			if (true) {
				IndustrialEconomyMod.PACKET_HANDLER.sendToServer(new SandstoneextractorGUIGui.ButtonPressedMessage(0, x, y, z));
				SandstoneextractorGUIGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
