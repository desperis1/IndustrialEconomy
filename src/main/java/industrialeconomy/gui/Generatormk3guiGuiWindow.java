...
public class Generatormk3guiGuiWindow extends ContainerScreen<Generatormk3guiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("industrial_economy:textures/generatormk_3gui.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "GENERATOR", 28, 4, -16777216);
		this.font.drawString(ms, "MK 3", 84, 4, -4636453);
		...
		this.font.drawString(ms, "+25 000 MW", 113, 4, -16763956);
	}
