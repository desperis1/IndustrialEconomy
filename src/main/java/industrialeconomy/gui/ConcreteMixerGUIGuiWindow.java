...
@OnlyIn(Dist.CLIENT)
public class ConcreteMixerGUIGuiWindow extends ContainerScreen<ConcreteMixerGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Concrete Mixer", 67, 4, -12829636);
		this.font.drawString(ms, "Concrete: " + (new Object() {
