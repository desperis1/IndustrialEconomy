...
public class AssemblerguiGuiWindow extends ContainerScreen<AssemblerguiGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 44, this.guiTop + 88, 90, 20, new StringTextComponent("Change Recipe"), e -> {
			if (true) {
				IndustrialEconomyMod.PACKET_HANDLER.sendToServer(new AssemblerguiGui.ButtonPressedMessage(0, x, y, z));
				AssemblerguiGui.handleButtonAction(entity, 0, x, y, z);
			}
		}));
	}
}
