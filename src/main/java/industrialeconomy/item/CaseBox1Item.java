...
import industrialeconomy.gui.CaseBoxGUIGuiWindow;
import industrialeconomy.gui.CaseBoxGUIGui;

import industrialeconomy.IndustrialEconomyModElements;

@IndustrialEconomyModElements.ModElement.Tag
public class CaseBox1Item extends IndustrialEconomyModElements.ModElement {
	@ObjectHolder("industrial_economy:case_box_1")
	public static final Item block = null;
	public CaseBox1Item(IndustrialEconomyModElements instance) {
		super(instance, 481);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CaseBoxGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Case Box 1");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CaseBoxGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
