...
public class ControlUnitItem extends IndustrialEconomyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Copper: 500"));
			list.add(new StringTextComponent("Caterium: 584"));
			list.add(new StringTextComponent("Iron: 2 343"));
			list.add(new StringTextComponent("Coal: 1 254"));
		}
	}
}
