...
import industrialeconomy.gui.PocketchestGuiWindow;
import industrialeconomy.gui.PocketchestGui;
...
public class PocketchestitemItem extends IndustrialEconomyModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PocketchestGuiWindow) {
