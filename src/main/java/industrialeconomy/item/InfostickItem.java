...
public class InfostickItem extends IndustrialEconomyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Right-Click on block you want info about(miners"));
			list.add(new StringTextComponent("generators"));
			list.add(new StringTextComponent("nodes)"));
		}
